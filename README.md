...
- `stats_file` – whether to generate a file containing detailed tournament statistics for
  each team; this specified file is created in the [data/](data) subdirectory for the
  project
...
Command line arguments often override the valued defined in the config file (which, in
...
- `elo_params`
  - `elo_db` – name of the file (within the [deal/](deal) directory) for maintaining Elo
    rating information
...
More detailed descriptions of the individual modules will be found in the README for their
various subdirectories (not yet complete).

For full module-/class-level documentation, see
[https://crashka.github.io/euchre-plt](https://crashka.github.io/euchre-plt) (generated
from [docs/](docs)).
